                            ...
                            <div class="card-body tab-content">
                                ...
                                <div class="tab-pane" id="orders">
                                    ...
                                    <ul class="nav nav-tabs mb-3">
                                        ...
                                        <li class="nav-item">
                                            <a href="#shipping" data-bs-toggle="pill" class="nav-link"> จัดส่งสินค้าแล้ว</a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="shipping">
                                            <!-- Display orders with parcel_id and parcel_name here -->
                                            <div class="container">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <article class="card">
                                                                    <div class="card-body row">
                                                                        ...
                                                                        <div class="col">สถานะคำสั่งซื้อ: <br> <span class="badge bg-danger"><?php echo $order['status']; ?></span> </div>
                                                                        <div class="col">ยอดรวม: <br> ฿<?php echo number_format($order['totalPrice'], 2, '.', ','); ?></div>
                                                                        <!-- Add parcel_id and parcel_name columns here -->
                                                                        <div class="col">หมายเลขการจัดส่ง: <br> <?php echo $order['parcel_id']; ?></div>
                                                                        <div class="col">ชื่อบริษัทขนส่ง: <br> <?php echo $order['parcel_name']; ?></div>
                                                                    </div>
                                                                </article>
