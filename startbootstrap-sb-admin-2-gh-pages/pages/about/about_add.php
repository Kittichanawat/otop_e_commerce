...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES["main_image"]["tmp_name"])) {
        ...
        // เพิ่มรหัสสุ่มในชื่อไฟล์
        $randomCode = uniqid(); // สร้างรหัสสุ่ม (unique ID)
        $newMainImgName = $randomCode . '.' . $fileExtension; // ต่อรหัสสุ่มกับนามสกุลไฟล์
        $mainImgTarget = $targetDirectory . basename($newMainImgName);
    ...
    $sql = "INSERT INTO about (a_title, a_detail, a_img, a_link,a_show) 
            VALUES ('$a_title', '$a_detail', '$mainImgPath', '$a_link','$a_show')";
      ...
      <?php include('../../web_stuc/side_bar.php');?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <div class="container">
    <h2>เพิ่มหน้าเกี่ยวกับ</h2>
    <form action="" method="post" enctype="multipart/form-data" onSubmit="return chkdata(this);">
        <div class="mb-3">
            <label for="a_title" class="form-label">หัวข้อ:</label>
            <input type="text" name="a_title" id="a_title" class="form-control">
        </div>
        <div class="mb-3">
            <label for="a_detail" class="form-label">รายละเอียด:</label>
            <textarea name="a_detail" id="a_detail" rows="4" class="form-control"></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="a_link" id="a_link" class="form-control">
        </div>
        <div class="mb-3">
                <label for="a_show" class="form-label">แสดงเกี่ยวกับ:</label>
                <select id="a_show" name="a_show" class="form-control">
