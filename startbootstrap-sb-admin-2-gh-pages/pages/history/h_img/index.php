    ...
    <tbody>
        ...
        if ($totalrows_result > 0) {
            while ($row_result = mysqli_fetch_assoc($result)) {
                ?>
                <tr>
                    <td><?php echo $row_result['h_title']; ?></td>
                   
                    <!-- ใช้ Bootstrap 5 class "text-truncate" เพื่อแสดงข้อความที่ยาวเกิน -->
                    <td class="text-truncate overflow-hidden" style="max-width: 200px;"><?php echo $row_result['h_detail']; ?></td>

             
                    <td><img src="<?php echo $row_result['h_img']; ?>" alt="" style="max-width: 100px; max-height: 100px;"></td>
                    <td><?php echo $row_result['h_link']; ?></td>
            
                 
                    <td><a href="history_edit.php?h_id=<?php echo $row_result['h_id']; ?>">แก้ไข</a></td>
                    <td><a href="history_delete.php?h_id=<?php echo $row_result['h_id']; ?>">ลบ</a></td>
                </tr>
                <?php
            }
        } else {
