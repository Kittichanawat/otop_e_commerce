...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $insert_sql = "INSERT INTO member (mmb_name, mmb_surname, mmb_username, mmb_pwd, mmb_addr,mmb_email, mmb_phone, member) VALUES ('$mmb_name', '$mmb_surname', '$mmb_username', '$password_hash', '$mmb_addr', '$mmb_email','$mmb_phone', '$member')";
    ...
    function chkdata(boarddata) {
        ...
        if (boarddata.mmb_pwd.value == "") {
            ...
            if (password.length < 6 || !/[0-9]/.test(password) || !/[a-z]/.test(password) || !/[A-Z]/.test(password)) {
                showError = 1;
                txtError = " รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษรและประกอบไปด้วยตัวเลข, ตัวอักษรตัวใหญ่และตัวอักษรตัวเล็ก";
            }
        }
                        ...
                        <form action="" method="POST" onSubmit="return(chkdata(this));">
                            ...
                            <div class="card-body px-4">
                                <div class="row g-2">
                                    ...
                                    <div class="col-12">
                                        <label for="mmb_email">Email<br>

                                        </label>
                                        <input type="email" id="mmb_email" class="form-control" name="mmb_email" >
                                    </div>
                                    <div class="col-12">
                                        <label for="mmb_phone">Phone<br>
