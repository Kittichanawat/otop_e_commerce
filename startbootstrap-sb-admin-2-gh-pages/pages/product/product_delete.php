...
if (isset($_GET['prd_id'])) {
    ...
    if (mysqli_query($proj_connect, $delete_img_sql)) {
        ...
        if (mysqli_query($proj_connect, $delete_sql)) {
            ...
            echo json_encode(['success' => false, 'message' => 'Error deleting product: ' . mysqli_error($proj_connect)]);
        }
    } else {
        echo json_encode(['success' => false, 'message' => 'Error deleting product images: ' . mysqli_error($proj_connect)]);
    }
} else {
...
<body id="page-top">
    ...
    <form method="POST">
        <input type="submit" name="confirm_delete"  class="btn btn-primary" value="Confirm Delete">
