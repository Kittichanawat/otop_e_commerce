...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO banking (bank_name, acc_name, bank_number,bank_img,bank_show) 
            VALUES ('$bank_name', '$acc_name', '$bank_number', '$mainImgPath','bank_show')";
...
<body id="page-top">
    ...
    <form action="" method="post" enctype="multipart/form-data"  onSubmit="return chkdata(this);">
        <div class="mb-3">
            <label for="bank_name" class="form-label">หัวข้อ:</label>
            <input type="text" name="bank_name" id="bank_name" class="form-control">
        </div>
        <div class="mb-3">
            <label for="acc_name" class="form-label">รายละเอียด:</label>
            <textarea name="acc_name" id="acc_name" rows="4" class="form-control"></textarea>
        </div>
        ...
        <div class="mb-3">
            <label for="bank_number" class="form-label">ลิงค์:</label>
            <input type="text" name="bank_number" id="bank_number" class="form-control">
        </div>
        <div class="mb-3">
                <label for="bank_show" class="form-label">แสดงหน้าต่างๆ:</label>
                <select id="bank_show" name="bank_show" class="form-control">
