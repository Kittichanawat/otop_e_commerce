                ...
                <?php if (isset($lineMemberData)) { ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-primary  link-a" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa-regular fa-user"></i> <?php echo $lineMemberData['mmb_username']; ?>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <?php if ( $lineMemberData['status'] == "superadmin" ||  $lineMemberData['status'] == "admin") { ?>
...
<?php } ?>
                            <li><a class="dropdown-item" href="profile.php?mmb_id=<?php echo  $lineMemberData['mmb_id']; ?>"><i class="fa-solid fa-user"></i> ประวัติส่วนตัว</a></li>
                            <li><a class="dropdown-item" href="member_edit.php?mmb_id=<?php echo  $lineMemberData['mmb_id']; ?>"><i class="fa-solid fa-gear"></i> แก้ไขโปรไฟล์</a></li>
                            <li><a class="dropdown-item" href="password_edit.php?mmb_id=<?php echo  $lineMemberData['mmb_id']; ?>"><i class="fa-solid fa-lock"></i> เปลี่ยนรหัสผ่าน</a></li>
