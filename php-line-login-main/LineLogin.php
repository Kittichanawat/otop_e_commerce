...
{
    #### change your id
    private const CLIENT_ID = '2001701953';
    private const CLIENT_SECRET = '6abf29eaaf14f02f4f826fb76caafe88';
    private const REDIRECT_URL = 'http://localhost/project-jarnsax/php-line-login-main/callback.php';
