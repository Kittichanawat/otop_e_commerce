...
` : '';
                    ...
                    if (item.mmb_username !== '<?php echo $_SESSION['mmb_username']; ?>'  && item.status !== 'superadmin') {
                        toggleMmbShow =
                    ...
                    tableData.push([
                        ...
                        `<a href="profile.php?id=${item.mmb_id}" class="btn btn-info">
        ...
        $(document).on('click', '.delete-manager', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "DELETE",
                        url: "../../service/members/delete.php?id=" +
