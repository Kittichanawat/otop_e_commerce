...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_stmt = $conn->prepare("UPDATE member SET mmb_name = :mmb_name, mmb_surname = :mmb_surname,mmb_username = :mmb_username,mmb_pwd = :mmb_pwd,  mmb_phone = :mmb_phone,mmb_email = :mmb_email WHERE mmb_id = :mmb_id");
            ...
            .serialize(), // รับข้อมูลจากฟอร์มและแปลงเป็นรูปแบบ URL-encoded
                success: function(response) {
                    ...
                    Swal.fire({
                        ...
                        location.assign(
                        '../manager/'); // หลังจากกด "ตกลง" ให้ redirect ไปยังหน้าอื่น (ตามที่คุณต้องการ)
                    });
                },
                error: function() {
                    // เกิดข้อผิดพลาด
