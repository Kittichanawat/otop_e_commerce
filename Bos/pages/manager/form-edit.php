...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_stmt = $conn->prepare("UPDATE member SET mmb_name = :mmb_name, mmb_surname = :mmb_surname, status = :status, mmb_phone = :mmb_phone,mmb_addr = :mmb_addr,mmb_email = :mmb_email WHERE mmb_id = :mmb_id");
    ...
    $update_stmt->bindParam(':mmb_addr', $mmb_addr, PDO::PARAM_STR);
                                            ...
                                            <div class="col-md-6 px-1 px-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status" id="permission" required>
                                                        <option value="admin"
                                                            <?php echo ($admin['status'] == "admin") ? 'selected' : ''; ?>>
                                                            Admin</option>
                                                        <option value="superadmin"
                                                            <?php echo ($admin['status'] == "superadmin") ? 'selected' : ''; ?>>
                                                            Super Admin</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="mmb_phone">ที่อยู่</label>
                                                    <textarea id="mmb_addr" class="form-control" name="mmb_addr" value="<?php echo htmlspecialchars($admin['mmb_addr']); ?>"></textarea>
                                                </div>
